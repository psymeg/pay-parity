...
nz_labourforce2 <- nz_row$labforce_participation
nz_rank2 <- nz_row$rank
total_countries2 <- nrow(labourforce_ranked)

# Report
cat(glue::glue(
  "New Zealand Labour Force Participation Index: {nz_labourforce2}\n",
  "Rank: {nz_rank2} out of {total_countries2} countries."
))
```

New Zealand's Labour Force Participation rate in 2022 was `r round(nz_pay_parity, 2)`, ranking `r nz_rank` out of `r total_countries` countries globally according to the World Economic Forum.
...
The data presented raises a number of thought-provoking questions. While New Zealand performs relatively well in pay parity, it lags behind in areas such as under-5 mortality and homicide rates. What connections, if any, might exist between gender equity and broader social outcomes? Could greater emphasis on pay parity contribute to improvements in other areas of wellbeing, or are these trends shaped by deeper, more complex forces? As New Zealand reflects on its priorities, this data invites a broader conversation about the interplay between equity, health, and safety.